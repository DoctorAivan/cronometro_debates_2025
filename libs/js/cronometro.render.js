...
//  Candidate Render Functions
    ...
    //  Candidate List
        ...
        //  Container render in HTML
            const render	=	document.getElementById('render-candidates')
        ...
        //  Create candidate elements
            ...
            //  Set candidate DIV options
                ...
                objeto.className = 'candidate gray-scale'
    ...
    //  Order candidates by time
        ...
        //  Descending order
            ...
            {
            //  candidates.sort((a, b) => (b.timer_total > a.timer_total) ? 1 : -1)
            //  candidates.sort((a, b) => (b.timer_total > a.timer_total) ? 1 : (b.timer_total === a.timer_total) ? ((a.last_name > b.last_name) ? 1 : -1) : -1 )
        ...
        //  Ascending order        
            ...
            {
            //  candidates.sort((a, b) => (a.timer_total > b.timer_total) ? 1 : -1)
            //  candidates.sort((a, b) => (a.timer_total > b.timer_total) ? 1 : (a.timer_total === b.timer_total) ? ((a.last_name > b.last_name) ? 1 : -1) : -1 )
            //  candidates.sort((a, b) => (a.timer_total > b.timer_total) ? 1 : (a.timer_total === b.timer_total) ? ((a.id > b.id) ? 1 : -1) : -1 )
